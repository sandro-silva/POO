...
public class TelaPrincipal extends JFrame{
	...
	public TelaPrincipal  (Cadastro sisCadastro2, TelaCadastro telaCadastro) { // menu ou caixa  construtor
		...
		itemSair.addActionListener(new ActionListener() { // ação pra sair
			public void actionPerformed(ActionEvent e) { // qnd clicar no botÃ£o executa abaixo comando
				System.exit(0);
			}
		}); 
		...
		JLabel linha1, linha2;
			ImageIcon provedorImg = new ImageIcon(getClass().getResource("josa_net.jpg"));
		    	setTitle("Provedor");
		        setSize(1600,1200); //tamanho da janela
		        setLocation(0, 0);
		        setResizable(false);
		        getContentPane().setBackground(Color.orange);
		        linha1 = new JLabel("Seja Bem Vindo", JLabel.CENTER);
