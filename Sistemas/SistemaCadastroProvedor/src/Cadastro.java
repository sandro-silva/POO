...
public class Cadastro {   // vários contatos(quantidade, lista)
	...
	public Contato pesquisaContato(String nomeContato) { //pesquisa
		for (int k=0; k<this.contatos.size(); k++) { // varre os números de elementos
	...
	public void salvarDados()  throws IOException{
		...
		gravarTexto(dadosContatos);
	                 ...
	                 // nome método         nome do arquivo        texto
